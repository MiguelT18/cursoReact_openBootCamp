...
const Ejemplo2 = () => {
   ...
   * Cada vez que haya un cambio en contador 1, se ejecuta lo que diga en el useEffect()
   ...
   * Cada vez que haya un cambio en contador 1, se ejecuta lo que diga en el useEffect()
   * Cada vez que haya un cambio en contador 2, se ejecuta lo que diga en el useEffect()
   */
